...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef NovaAmmo1 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "NovaFrag", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 40, green: 40, blue: 60, alpha: 1),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 1,
